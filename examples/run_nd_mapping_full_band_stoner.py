...
def save_map_outputs(out: Path, rows: list[dict[str, Any]], n_values: list[float], d_values: list[float]) -> None:
    ...
    plot_specs = [
        ...
        ("spin_polarization_norm", "Normalized spin polarization"),
        ("valley_polarization", "Valley polarization"),
        ("valley_polarization_norm", "Normalized valley polarization"),
        ("spin_valley_polarization", "Spin-valley polarization"),
        ("spin_valley_polarization_norm", "Normalized spin-valley polarization"),
        ("dos_mu_scf", "Full-band DOS at SCF mu"),
